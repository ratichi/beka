...
<AnimatePresence>
  {open && (
    ...
    >
      ...
      <div className="flex flex-col md:grid md:grid-cols-12 overflow-x-hidden">
        {/* Categories */}
        <div className="md:col-span-4 md:border-r border-gray-100 p-2">
          <div className="flex md:block gap-2 md:gap-0 overflow-x-auto md:overflow-visible no-scrollbar">
            {categories.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className={[
                    "shrink-0 md:w-full text-left px-3 py-2 rounded-xl transition flex items-center justify-between",
                    isActive
                ...
                >
                  ...
                  <span className="text-xs text-gray-400 md:inline hidden">
        ...
        {/* Items */}
        <div className="md:col-span-8 p-4 overflow-x-hidden">
          <div className="flex items-center justify-between gap-4 mb-3">
            ...
            <Link
              href={`/${locale}/services/${activeCategory}`}
              className="text-sm px-3 py-1.5 rounded-lg bg-gray-50 hover:bg-gray-100 text-gray-700 transition shrink-0"
            >
